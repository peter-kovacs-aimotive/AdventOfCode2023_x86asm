...
endOfLine:
	...
	mov ebp, dword[numberOfRed]
	call printResult
	call printSpace
	
	mov ebp, dword[numberOfGreen]
	call printResult
	call printSpace

	mov ebp, dword[numberOfBlue]
	call printResult
	call printSpace

	mov eax, dword[numberOfRed]
	mov edx, dword[numberOfGreen]
	mul edx
	mov edx, dword[numberOfBlue]
	mul edx
	
	add dword[totalPowerOfGames], eax
...
endOfFile:
	...
	mov ebp, dword[totalPowerOfGames]
	call printResult
	call printNewLine
